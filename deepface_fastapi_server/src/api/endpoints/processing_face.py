...
async def process_single_face_image(img_input: str, request_params: ProcessImagesRequest) -> FaceImageProcessingResult:
    ...
    if saved_image_path and image_faces_results and image_faces_results[0].facial_area:
        ...
        if isinstance(face_area_to_crop, FacialArea):
            ...
            try:
                ...
                final_cropped_face_path = common.crop_and_save_object(
                    original_image_path=saved_image_path,
                    object_coords=face_area_to_crop,
